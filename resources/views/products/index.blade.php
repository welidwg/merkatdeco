    ...
    <div class="card shadow text-size-md">
        ...
        <div class="card-body">
            <div class="table-responsive table mt-2 border-0" role="grid" aria-describedby="">
                ...
                @foreach ($prods as $prod)
                    <div class="offcanvas offcanvas-end text-size-md" data-bs-scroll="true" tabindex="-1"
                        style="width: 600px" id="canvas_{{ $prod->id }}"
                        ...
                        <div class="offcanvas-body d-flex align-items-start">
                            <form class="border-1 border-primary shadow-sm p-3 rounded-4 col-12 col-md-6 text-size-md w-100"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select text-size-md" id="subCategsSelect"
                                                name="sub_category_id" @if ($prod->sub_category == null) disabled @endif>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="" class="form-label">Mesures <a
                                                    id="add_measures{{ $prod->id }}"><i class="fas fa-plus"
                                                    ...
                                                    <div class=" row mb-3">
                                                        ...
                                                        <div class="col-5">
                                                            <div class="input-group mb-1">
                                                                <input type="number" step="0.1" placeholder="prix"
                                                                    min="0" name="pricesArr{{ $prod->id }}[]"
                                                                    class="form-control text-size-md shadow-none"
                                                                    id="" value="{{ $measure->price }}">
                                ...
                                <button type="submit" class="btn btn-primary float-end"
                                    id="add_btn_prod">Enregistrer</button>
                            </form>
                        </div>
                    </div>
                    <script>
